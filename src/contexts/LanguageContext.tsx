...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "hero.stat.yearsValue": "7+ Years",
    "hero.stat.yearsLabel": "Industry experience",
    "hero.stat.domainValue": "Manufacturing",
    "hero.stat.domainLabel": "Automotive & industry",
    "hero.stat.focusValue": "Industry 4.0",
    "hero.stat.focusLabel": "Smart factory & analytics",
    "skills.level": "Level",
    "cta.heading": "Open to Digital Manufacturing & IIoT roles",
    "cta.description":
      "Happy to talk through smart-factory, analytics, or transformation work — a call is the fastest way to start.",
    "timeline.professionalJourney": "Professional Journey",
    "timeline.journeyDescription":
    ...
    "skills.competenciesDescription":
    ...
    "contact.form.disabledDescription":
      "The contact form is currently disabled. Please use the email link instead.",
    "contact.form.disabledNotice":
  ...
  de: {
    ...
    "hero.stat.yearsValue": "7+ Jahre",
    "hero.stat.yearsLabel": "Berufserfahrung",
    "hero.stat.domainValue": "Fertigung",
    "hero.stat.domainLabel": "Automotive & Industrie",
    "hero.stat.focusValue": "Industrie 4.0",
    "hero.stat.focusLabel": "Smart Factory & Analytics",
    "skills.level": "Niveau",
    "cta.heading": "Offen für Rollen in Digital Manufacturing & IIoT",
    "cta.description":
      "Gerne sprechen wir über Smart-Factory-, Analytics- oder Transformationsprojekte — ein Gespräch ist der schnellste Einstieg.",
    "timeline.professionalJourney": "Beruflicher Werdegang",
    "timeline.journeyDescription":
      "Erfahrungen und Bildung, die meine Karriere in der digitalen Transformation geprägt haben.",
    ...
    "skills.skillsDescription":
      "Kernkompetenzen und technische Fähigkeiten in Geschäfts- und Technologiebereichen.",
    ...
    "contact.contactDescription":
      "Interessiert an der Diskussion von Möglichkeiten der digitalen Transformation?",
    ...
    "contact.form.messagePlaceholder":
      "Erzählen Sie mir von Ihren Anforderungen zur digitalen Transformation...",
    ...
    "contact.form.errorDescription":
      "Beim Senden Ihrer Nachricht ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut oder kontaktieren Sie mich direkt per E-Mail.",
    "contact.form.disabledTitle": "Kontaktformular deaktiviert",
    "contact.form.disabledDescription":
      "Das Kontaktformular ist derzeit deaktiviert. Bitte verwenden Sie stattdessen den E-Mail-Link.",
    "contact.form.disabledNotice":
      "Das Kontaktformular ist derzeit deaktiviert. Bitte verwenden Sie den obigen E-Mail-Link.",
    "cookies.title": "Cookie-Einstellungen",
    "cookies.description":
      "Wir verwenden Cookies, um Ihre Erfahrung zu verbessern und die Website-Nutzung zu analysieren.",
    ...
    "cookies.essential.description":
      "Erforderlich für grundlegende Website-Funktionen und Benutzereinstellungen.",
    "cookies.analytics.title": "Analyse-Cookies",
    "cookies.analytics.description":
      "Helfen uns zu verstehen, wie Sie mit unserer Website interagieren.",
