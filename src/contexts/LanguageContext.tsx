...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'cta.description': 'Happy to talk through smart-factory, analytics, or transformation work — a call is the fastest way to start.',
  ...
  de: {
    ...
    'cta.description': 'Gerne sprechen wir über Smart-Factory-, Analytics- oder Transformationsprojekte — ein Gespräch ist der schnellste Einstieg.',
