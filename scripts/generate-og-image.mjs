...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#246B65;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#32857E;stop-opacity:1" />
    </linearGradient>
  </defs>
  <rect width="${width}" height="${height}" fill="url(#bg)"/>
  <!-- Subtle accent line -->
  <rect x="80" y="180" width="60" height="4" rx="2" fill="#32857E"/>
  <!-- Name -->
  ...
  <!-- Stats row -->
  <text x="80" y="390" font-family="Arial, Helvetica, sans-serif" font-size="22" fill="#32857E">7+ Years</text>
  <text x="230" y="390" font-family="Arial, Helvetica, sans-serif" font-size="22" fill="#475569">|</text>
  <text x="260" y="390" font-family="Arial, Helvetica, sans-serif" font-size="22" fill="#32857E">150+ Use Cases</text>
  <text x="510" y="390" font-family="Arial, Helvetica, sans-serif" font-size="22" fill="#475569">|</text>
  <text x="540" y="390" font-family="Arial, Helvetica, sans-serif" font-size="22" fill="#32857E">€1M+ Savings</text>
  <!-- Keywords -->
  ...
  <!-- Decorative circles -->
  <circle cx="1050" cy="150" r="120" fill="#32857E" opacity="0.05"/>
  <circle cx="1100" cy="400" r="180" fill="#32857E" opacity="0.03"/>
</svg>`;
